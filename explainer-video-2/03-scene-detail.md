...
> **STATUS PRODUKSI (per 2026-06-29 · update penanda ini tiap shot selesai):** SH01 ✅ DONE (start+end). SH02 ✅ DONE (start+end). SH03 ✅ DONE (start+end). SH04–SH07 ⬜ BELUM. Penanda lama "(DONE — accepted)" = sisa sesi 2026-06-26 yang file-nya tak ada di disk → dikoreksi & diregenerasi ulang.
