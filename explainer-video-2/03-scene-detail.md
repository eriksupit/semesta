...
- **SEQ1-SC02-SH03** — WS. start: takbiratul ihram, empat orang satu saf-imam. end: gerak rukuk serempak. *(zona sakral — nol grafis)*
- **SEQ1-SC02-SH04** — WS lembut / high-angle. start: posisi sujud. end: frame tenang menahan, bersih total dari UI. *(35mm)*
