---
title: Claude Project Instructions — Semesta Digital (Source)
tags: [meta, project-instructions]
status: active
created: 2026-06-08
updated: 2026-06-08
---

# Claude Project Instructions — Source File
## Semesta Digital *(working title)*

*This file is the source of truth for the text pasted into Claude Project "superapps" > Set project instructions. Update this file whenever the project scope or structure changes significantly, then re-paste into the project settings.*

---

## Text to paste into "Set project instructions"
...
STEP 1 — BOOTSTRAP (mandatory first action, before any response)
  ...
  1. /Users/eriksupit/Desktop/superapps/scope.md
  2. /Users/eriksupit/Desktop/superapps/context.md
  3. /Users/eriksupit/Desktop/superapps/lessons.md
  4. Most recent HANDOFF-*.md in /Users/eriksupit/Desktop/superapps/handoff/
  5. Any additional vault files required by the task
...
LAST ACTIVE SESSION: 2026-06-08
Sessions 1 & 2 completed: full explainer video production package (01-07), vault + meta files setup,
/session-anchors skill created at .claude/skills/session-anchors/SKILL.md.
NEXT SESSION MANDATE: Produce 08-investor-deck-brief.md (investor deck master brief).
Initial prompt: /Users/eriksupit/Desktop/superapps/handoff/INITIAL-PROMPT-2026-06-08-S3.txt
```
