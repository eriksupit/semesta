...
| Image-to-Video A | Kling AI Premier | Dynamic scenes: characters 2, 3, 5 | Manual -- web UI |
...
```
Step 1: Upload approved anchor image
Step 2: Input scene prompt with motion direction (from 02-production-brief.md)
Step 3: Generate -- Kling Premier (200 credits/10 sec, Pro model, 1080p)
Step 4: Evaluate: motion quality, character integrity, dramatic composition
Step 5: If pass -> save to video-clips/
